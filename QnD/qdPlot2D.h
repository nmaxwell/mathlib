...
/*
 *  This is NOT meant to be a quality plotting library
 * 
 *  This is a quick and dirty plotting library
 * 
 ...
 *
 * 	I've tried to keep the code itself pretty decent; aiming for robustness and minimalism
 * 
 */
